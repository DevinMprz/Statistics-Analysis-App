    ...
    <div className="mainMenuContainer">
      <div className="gridItem">
        <div className="description">
          <h1>Minitool 1</h1>
          <p>
            Minitool 1 zobrazuje dve sady jednorozmerných (univariate) dát po
            max 10 až 12 bodov každá, ako „line graph“.
          </p>
        </div>
      ...
      <div className="gridItem">
        <div className="description">
          <h1>Minitool 2</h1>
          <p>
            Minitool 2 zobrazuje dve sady jednorozmerných (univariate) dát po
            max 250 až 300 bodov každá, ako „dot plot“.
          </p>
        </div>
